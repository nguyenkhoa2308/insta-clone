...
export const HomeIcon = ({ className, filled = false }: IconProps) => (
...
export const SearchIcon = ({ className, filled = false }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    {filled ? (
      <>
        <path
...
export const ExploreIcon = ({ className, filled = false }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    {filled ? (
      <path
...
export const ReelsIcon = ({ className, filled = false }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    {filled ? (
      <path
...
export const MessagesIcon = ({ className, filled = false }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    {filled ? (
      <path
...
export const NotificationsIcon = ({ className, filled = false }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none">
    {filled ? (
      <path
